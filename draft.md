...
Imagine our table is hosting an arm-wrestling contest.  All of our contestants have a Strength (STR) ability score, generated by rolling **3d6**.  This gives us 16 possible strength scores ranging from 3 to 18, representing the full range of human ability.  In a showdown between two opponents, how do we determine the winner?

<img class="left" alt="A pitiful little goblin" src="/images/goblin.png" /> In the first corner, this pitiful little Goblin!

* He rolled all ones on his STR roll
* He's as weak as the weakest ~6% of humans
* There's no way he's gonna win this thing.

In the next corner, this mighty Ogre!  <img class="right" alt="A massive, flexing ogre" src="/images/ogre.png" />
